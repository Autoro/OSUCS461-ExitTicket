...
from OSUCS461.Classes.Database.userdb import UserDB
from OSUCS461.Classes.Database.userpostdb import UserPostDB
from OSUCS461.Models.user import UserWrite
from OSUCS461.Models.userpost import UserPostWrite
...
async def get_all_user_posts(user_id: str):
    try:
